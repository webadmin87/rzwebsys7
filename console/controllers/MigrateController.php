...
class MigrateController extends Controller
{
    ...
    /**
     * @var string the directory using for applying migration
     */
    public $applyPath;
    /**
    ...
    public function options($actionId)
    {
        return array_merge(
            ...
            ['applyPath', 'migrationPath', 'migrationLookup', 'migrationTable', 'db'], // global for all actions
    ...
    protected function getMigrationHistory($limit)
    {
        ...
        $query   = new Query;
        $query->select(['version', 'alias', 'apply_time'])
        ...
        if($this->applyPath)
            $query->where(['alias'=>$this->applyPath]);
