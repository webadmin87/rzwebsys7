...
$this->title = \Yii::t($this->context->tFile, 'Comments');
...
<div class="user-index">
    ...
    <?= Breadcrumbs::widget([
        ...
        'links' => $searchModel->getBreadCrumbsItems($parent_id, function($model) { return ["/".Yii::$app->controller->route, "parent_id"=>$model->id]; }, "username"),
    ]) ?>
