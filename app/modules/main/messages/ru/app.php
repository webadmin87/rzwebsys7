...
return [
    ...
    'Review' => 'Отзыв',
    'Reviews' => 'Отзывы',
    'Reviews Count' => 'Количество',
    'Rating' => 'Рейтинг',
    'Rating Total' => 'Суммарный рейтинг',
    'Rating Average' => 'Средний рейтинг',
    'Review Success Message' => 'Ваш отзыв успешно принят на рассмотрение.',
    'Review Error Message' => 'Ошибка при форомлении отзыва',
];